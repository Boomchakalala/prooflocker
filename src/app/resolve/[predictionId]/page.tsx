    ...
    <div className="min-h-screen gradient-bg text-white">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-6 md:py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="glass border border-white/10 rounded-xl p-5 md:p-6">
            <h2 className="text-lg font-semibold text-white mb-1">Additional Notes</h2>
            <p className="text-xs text-neutral-400 mb-4">Optional context or explanation</p>
            <textarea
          ...
          <div className="glass border border-white/10 rounded-xl p-5 md:p-6">
            <button
              type="submit"
              disabled={submitting}
              className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold text-base rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 mb-3"
            >
              {submitting ? (
                <>
