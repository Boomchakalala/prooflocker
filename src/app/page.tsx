        ...
        <div className="relative z-10 py-20 md:py-28 px-6 bg-gradient-to-b from-[#0a0a0a] via-[#1A0033]/30 to-[#0a0a0a]">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <Link
                href="/lock"
                className="w-full sm:w-auto px-12 py-4 bg-gradient-to-r from-[#00bfff] to-[#9370db] hover:from-[#00a8e6] hover:to-[#7d5fc7] text-white text-lg font-bold rounded-xl transition-all shadow-2xl hover:shadow-3xl hover:scale-[1.02] btn-glow"
              >
                Lock Now
              </Link>
              <Link
                href="/app"
                className="w-full sm:w-auto px-12 py-4 border-2 border-white/20 hover:border-[#9370db] hover:bg-white/5 text-white text-lg font-bold rounded-xl transition-all"
              >
                Explore Proofs
              </Link>
            </div>
            ...
            <div className="flex items-center justify-center gap-8 mt-8">
              <a href="https://twitter.com/prooflocker" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#00bfff] transition-colors opacity-60 hover:opacity-100">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://discord.gg/prooflocker" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#00bfff] transition-colors opacity-60 hover:opacity-100">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://t.me/prooflocker" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#00bfff] transition-colors opacity-60 hover:opacity-100">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
