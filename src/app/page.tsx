        ...
        <div className="relative z-10 py-12 md:py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="glass border border-white/10 rounded-3xl p-5 sm:p-7 md:p-10 glow-purple">
              ...
              <Link
                href="/lock"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 active:from-blue-700 active:to-purple-700 text-white text-lg font-semibold rounded-lg transition-all shadow-lg shadow-blue-500/25 hover:shadow-purple-500/50"
              >
                Lock my prediction
