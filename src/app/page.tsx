      ...
      <main className="space-y-0">
        ...
        <div className="relative z-10 py-20 md:py-28 px-6 bg-gradient-to-b from-[#0A0A0F] via-[#111118]/30 to-[#0A0A0F]">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            ...
            {/* Powered by badge */}
            <div className="mt-12 flex items-center justify-center gap-2 text-sm text-[#9CA3AF]">
              <svg className="w-4 h-4 text-[#2E5CFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/>
              </svg>
              <span>Powered by <span className="text-[#5B21B6] font-semibold">Constellation DAG</span></span>
            </div>
          </div>
        </div>
