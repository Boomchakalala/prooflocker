  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] relative">
      ...
      <main className="space-y-0">{/* Hero Section */}
        ...
        {/* Final CTA Section */}
        <div className="relative z-10 py-20 px-6 bg-gradient-to-b from-[#0a0a0a] to-[#1a0033]">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-5xl md:text-6xl font-bold text-white mb-6" style={{ fontFamily: 'var(--font-montserrat)' }}>
              Ready to Lock In?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
              <Link
                href="/lock"
                className="w-full sm:w-auto px-10 py-4 bg-[#00bfff] hover:bg-[#00a8e6] text-white text-xl font-bold rounded-md transition-all shadow-2xl hover:shadow-3xl hover:scale-105 btn-glow"
              >
                Lock Now
              </Link>
              <Link
                href="/app"
                className="w-full sm:w-auto px-10 py-4 border-2 border-[#9370db] hover:bg-[#9370db]/10 text-white text-xl font-bold rounded-md transition-all"
              >
                Explore Proofs
              </Link>
            </div>
