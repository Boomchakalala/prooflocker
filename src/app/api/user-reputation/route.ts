...
// API route: /api/user-reputation (renamed from user-reliability)
// Calculates and returns user reputation scores and tiers
    ...
    if (userIds.length > 0) {
      ...
      if (userPredictions) {
        for (const userId of userIds) {
          ...
          const reputationScore = calculateReliabilityScore({
