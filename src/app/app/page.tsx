    ...
    <div className="min-h-screen gradient-bg relative">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-5 md:py-5 relative z-10">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Link
            href="/lock"
            className="hidden sm:flex px-5 py-2.5 bg-gradient-to-r from-blue-600/80 to-purple-600/80 hover:from-blue-600 hover:to-purple-600 text-white text-sm font-medium rounded-md transition-all"
          >
            Lock my prediction
          </Link>
        </div>
        ...
        {loading ? (
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 mb-6 text-left">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    ...
                    Access your proofs from any device
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    Keep your proofs safe if you clear browser data
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    Prove ownership of your proofs
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    Still anonymous - proofs stay on-chain, public, immutable
                  </li>
                </ul>
              </div>
              <button
          ...
          <div className="text-center py-20 fade-in">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">
              {activeTab === "all"
                ? "No proofs locked yet"
                : "No proofs"}
            </h3>
            <p className="text-neutral-400 mb-8 text-lg">
              {activeTab === "all"
                ? "No proofs have been locked yet"
                : "Create your first immutable proof"}
            </p>
            <Link
              href="/lock"
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600/80 to-purple-600/80 hover:from-blue-600 hover:to-purple-600 text-white font-medium rounded-md transition-all"
