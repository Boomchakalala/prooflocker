...
export default function AppFeedPage() {
  ...
  // Ticker items - mix of latest OSINT and Claims
  ...
  // Filter logic with quick filters
  ...
  return (
    <div className="min-h-screen gradient-bg text-white relative overflow-hidden">
      {/* Subtle feed identity - left gradient line */}
      ...
      <main className="max-w-7xl mx-auto px-4 pt-20 pb-12">
        ...
        <div className="mb-4 bg-gradient-to-r from-slate-900/80 via-slate-900/60 to-slate-900/80 backdrop-blur-xl border border-purple-500/20 rounded-lg px-4 py-2.5 shadow-lg overflow-hidden">
          <div className="flex items-center gap-3 animate-[slideIn_0.5s_ease-out]">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-6 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-bold text-orange-400">{resolvedIncorrect}</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-bold text-amber-400">{osintSignals.length}</span>
              </div>
            </div>
              ...
              <div className="flex-1 min-w-[200px] max-w-md">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-16 py-2 bg-white/5 border border-white/10 rounded-md text-sm text-white placeholder-neutral-500 focus:outline-none focus:border-purple-500/40 transition-colors"
                  />
                  <kbd className="absolute right-3 top-1/2 transform -translate-y-1/2 px-1.5 py-0.5 text-[10px] font-semibold text-neutral-500 bg-white/5 border border-white/10 rounded">
                    ⌘K
                  </kbd>
                </div>
              </div>
                    ...
                    {filteredPredictions.map((claim) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Timestamp Footer - Hash left, Date right */}
