  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 pt-20 md:pt-20 pb-12">
        ...
        <div className="mb-3 md:mb-4 bg-slate-900/40 backdrop-blur-sm border border-slate-700/30 rounded-xl px-3 md:px-4 py-2 md:py-2.5">
        ...
        <div className="sticky top-16 z-[100] bg-[#0a0a0f]/98 backdrop-blur-sm border-b border-slate-700/30 -mx-4 px-4 py-2 md:py-3 mb-4 md:mb-6">
