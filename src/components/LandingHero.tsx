...
export default function LandingHero() {
  return (
    <div className="relative z-10 min-h-[60vh] flex items-center justify-center text-center py-16 px-6 bg-slate-950">
      <div className="max-w-6xl mx-auto">
        ...
        <Link
          href="/app"
          className="text-blue-400 hover:text-blue-300 text-base font-semibold underline hover:no-underline transition-all"
        >
