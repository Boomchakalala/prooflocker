...
export default function LandingHero() {
  ...
  return (
    <div className="relative z-10 min-h-[80vh] flex items-center justify-center py-20 px-6 overflow-hidden gradient-bg">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        {/* Main headline */}
        <h1
          className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight leading-tight text-shadow-blue"
        ...
        {/* Subheading */}
        <p className="text-xl md:text-2xl text-[#d3d3d3] mb-12 max-w-3xl mx-auto" style={{ fontFamily: 'var(--font-inter)' }}>
          Declare it now. Prove it later — immutable on Constellation DAG.
        </p>

        {/* Key benefits with left-aligned bullets */}
        <div className="max-w-3xl mx-auto mb-14 space-y-4 text-left">
          <div className="flex items-start gap-4">
            <svg className="w-6 h-6 text-[#00bfff] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <Link
            href="/lock"
            className="px-8 py-4 bg-[#9370db] hover:bg-[#7d5fc7] text-white text-lg font-bold rounded-md transition-all shadow-xl hover:shadow-2xl hover:scale-105 flex items-center gap-2 btn-glow"
          >
          ...
          <Link
            href="/app"
            className="px-8 py-4 border-2 border-[#00bfff] hover:bg-[#00bfff]/10 text-white text-lg font-bold rounded-md transition-all flex items-center gap-2"
          >
