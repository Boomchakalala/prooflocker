  ...
  return (
    <div className="relative z-10 text-center py-12 md:py-16 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Main headline */}
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 sm:mb-5 md:mb-6 tracking-tight leading-tight">
          Predictions.{" "}
        ...
        {/* CTA Buttons */}
        <div className="relative flex flex-col sm:flex-row items-center justify-center gap-5 mb-5 md:w-[min(520px,100%)] md:mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 md:gap-2.5 text-sm mt-6 sm:mt-7 opacity-80">
          <div className="glass border border-white/10 rounded-full px-3 py-1.5 md:px-4 md:py-2 flex items-center gap-2 glow-blue">
            ...
            <span className="text-white font-medium text-xs md:text-sm">Anonymous by default</span>
          </div>
          <div className="glass border border-white/10 rounded-full px-3 py-1.5 md:px-4 md:py-2 flex items-center gap-2 glow-purple">
            <svg className="w-4 h-4 md:w-5 md:h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
            <span className="text-white font-medium text-xs md:text-sm">Locked on-chain</span>
          </div>
          <div className="glass border border-white/10 rounded-full px-3 py-1.5 md:px-4 md:py-2 flex items-center gap-2 glow-blue">
            ...
            <span className="text-white font-medium text-xs md:text-sm">Immutable proof</span>
          </div>
          <div className="glass border border-white/10 rounded-full px-3 py-1.5 md:px-4 md:py-2 flex items-center gap-2 glow-purple">
            ...
            <span className="text-white font-medium text-xs md:text-sm">Shareable cards</span>
          </div>
        </div>
      </div>
    </div>
