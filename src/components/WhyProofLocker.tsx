      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-br from-purple-600/5 via-blue-600/5 to-purple-700/5 border border-white/10 hover:border-white/20 rounded-2xl shadow-lg transition-all duration-300 p-6 flex flex-col h-full hover:shadow-[0_0_30px_rgba(147,112,219,0.12)]">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4 bg-gradient-to-br from-[#00bfff]/10 to-[#9370db]/10">
              <svg className="w-8 h-8 text-[#9370db]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
            </div>
            <h3 className="text-base md:text-lg font-bold text-white mb-2.5">Anonymous by Default</h3>
          ...
          <div className="bg-gradient-to-br from-purple-600/5 via-blue-600/5 to-purple-700/5 border border-white/10 hover:border-white/20 rounded-2xl shadow-lg transition-all duration-300 p-6 flex flex-col h-full hover:shadow-[0_0_30px_rgba(147,112,219,0.12)]">
            ...
            <h3 className="text-base md:text-lg font-bold text-white mb-2.5">Public or Private Control</h3>
            <p className="text-gray-400 text-sm leading-relaxed flex-grow">
          ...
          <div className="bg-gradient-to-br from-purple-600/5 via-blue-600/5 to-purple-700/5 border border-white/10 hover:border-white/20 rounded-2xl shadow-lg transition-all duration-300 p-6 flex flex-col h-full hover:shadow-[0_0_30px_rgba(147,112,219,0.12)]">
            ...
            <h3 className="text-base md:text-lg font-bold text-white mb-2.5">Immutable On-Chain Proof</h3>
            <p className="text-gray-400 text-sm leading-relaxed flex-grow">
          ...
          <div className="bg-gradient-to-br from-purple-600/5 via-blue-600/5 to-purple-700/5 border border-white/10 hover:border-white/20 rounded-2xl shadow-lg transition-all duration-300 p-6 flex flex-col h-full hover:shadow-[0_0_30px_rgba(147,112,219,0.12)]">
            ...
            <h3 className="text-base md:text-lg font-bold text-white mb-2.5">Shareable Proof Cards</h3>
            <p className="text-gray-400 text-sm leading-relaxed flex-grow">
          ...
          <div className="bg-gradient-to-br from-purple-600/5 via-blue-600/5 to-purple-700/5 border border-white/10 hover:border-white/20 rounded-2xl shadow-lg transition-all duration-300 p-6 flex flex-col h-full hover:shadow-[0_0_30px_rgba(147,112,219,0.12)]">
            ...
            <h3 className="text-base md:text-lg font-bold text-white mb-2.5">Business Accountability</h3>
            <p className="text-gray-400 text-sm leading-relaxed flex-grow">
          ...
          <div className="bg-gradient-to-br from-purple-600/5 via-blue-600/5 to-purple-700/5 border border-white/10 hover:border-white/20 rounded-2xl shadow-lg transition-all duration-300 p-6 flex flex-col h-full hover:shadow-[0_0_30px_rgba(147,112,219,0.12)]">
            ...
            <h3 className="text-base md:text-lg font-bold text-white mb-2.5">Personal Challenges</h3>
            <p className="text-gray-400 text-sm leading-relaxed flex-grow">
