...
export default function ResolveModal({
  ...
  return (
    <div
      ...
      onClick={onClose}
      style={{
        // CSS variable for modal header height
        ['--modal-header-h' as string]: '64px',
      }}
    >
      {/* Backdrop */}
      <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" />

      {/* Modal Container - max height to fit viewport */}
      <div
      ...
      >
        ...
        <div
          ...
          style={{ height: 'var(--modal-header-h)' }}
        >
        ...
        {/* Scrollable Content Container - Single source of scroll */}
        <div
          className="overflow-y-auto overscroll-contain"
          style={{
            height: 'calc(100vh - 2rem - var(--modal-header-h) - 140px)', // Account for padding, header, and footer
            maxHeight: '70vh',
          }}
        >
          <form onSubmit={handleSubmit} className="flex flex-col h-full">
            {/* Content with minimal top padding */}
        ...
        <div className="flex-shrink-0 px-5 py-4 border-t border-white/10 bg-[#0a0a0a]/50 backdrop-blur-sm">
