  ...
  return (
    <div className="glass rounded-lg p-3 md:p-4 hover:border-white/10 transition-all flex flex-col h-full shadow-lg shadow-purple-500/5">
      ...
      <div className="flex items-center gap-1.5 mb-3 overflow-x-auto no-scrollbar">
        ...
        {/* Claimed badge */}
        {isClaimed && (
          <span className="px-2 py-0.5 text-[10px] font-medium rounded bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 whitespace-nowrap flex-shrink-0 flex items-center gap-1">
