...
export const COUNTRY_CENTROIDS: CountryCentroid[] = [
  ...
  // Africa
  { code: 'SO', name: 'Somalia', lat: 5.1521, lon: 46.1996 },
  { code: 'SD', name: 'Sudan', lat: 12.8628, lon: 30.2176 },
  { code: 'SS', name: 'South Sudan', lat: 6.877, lon: 31.307 },
  { code: 'LY', name: 'Libya', lat: 26.3351, lon: 17.2283 },
  { code: 'TN', name: 'Tunisia', lat: 33.8869, lon: 9.5375 },
  { code: 'MA', name: 'Morocco', lat: 31.7917, lon: -7.0926 },
  { code: 'DZ', name: 'Algeria', lat: 28.0339, lon: 1.6596 },
  { code: 'CD', name: 'Democratic Republic of the Congo', lat: -4.0383, lon: 21.7587 },
  { code: 'CG', name: 'Republic of the Congo', lat: -0.228, lon: 15.8277 },
  { code: 'GH', name: 'Ghana', lat: 7.9465, lon: -1.0232 },
  { code: 'TZ', name: 'Tanzania', lat: -6.369, lon: 34.8888 },
  { code: 'UG', name: 'Uganda', lat: 1.3733, lon: 32.2903 },
  { code: 'RW', name: 'Rwanda', lat: -1.9403, lon: 29.8739 },
  { code: 'MZ', name: 'Mozambique', lat: -18.6657, lon: 35.5296 },
  { code: 'ZW', name: 'Zimbabwe', lat: -19.0154, lon: 29.1549 },
  { code: 'CM', name: 'Cameroon', lat: 7.3697, lon: 12.3547 },
  { code: 'SN', name: 'Senegal', lat: 14.4974, lon: -14.4524 },
  { code: 'ML', name: 'Mali', lat: 17.5707, lon: -3.9962 },
  { code: 'TD', name: 'Chad', lat: 15.4542, lon: 18.7322 },
  { code: 'NE', name: 'Niger', lat: 17.6078, lon: 8.0817 },
  { code: 'BF', name: 'Burkina Faso', lat: 12.2383, lon: -1.5616 },
  { code: 'CI', name: 'Ivory Coast', lat: 7.54, lon: -5.5471 },
  { code: 'AO', name: 'Angola', lat: -11.2027, lon: 17.8739 },
  { code: 'MG', name: 'Madagascar', lat: -18.7669, lon: 46.8691 },
  { code: 'ER', name: 'Eritrea', lat: 15.1794, lon: 39.7823 },
  { code: 'DJ', name: 'Djibouti', lat: 11.8251, lon: 42.5903 },
  // Middle East & Central Asia
  { code: 'QA', name: 'Qatar', lat: 25.3548, lon: 51.1839 },
  { code: 'KW', name: 'Kuwait', lat: 29.3117, lon: 47.4818 },
  { code: 'BH', name: 'Bahrain', lat: 26.0667, lon: 50.5577 },
  { code: 'OM', name: 'Oman', lat: 21.4735, lon: 55.9754 },
  { code: 'PS', name: 'Palestine', lat: 31.9522, lon: 35.2332 },
  { code: 'TM', name: 'Turkmenistan', lat: 38.9697, lon: 59.5563 },
  { code: 'TJ', name: 'Tajikistan', lat: 38.861, lon: 71.2761 },
  { code: 'KG', name: 'Kyrgyzstan', lat: 41.2044, lon: 74.7661 },
  // Americas
  { code: 'HT', name: 'Haiti', lat: 18.9712, lon: -72.2852 },
  { code: 'DO', name: 'Dominican Republic', lat: 18.7357, lon: -70.1627 },
  { code: 'GT', name: 'Guatemala', lat: 15.7835, lon: -90.2308 },
  { code: 'HN', name: 'Honduras', lat: 15.2, lon: -86.2419 },
  { code: 'SV', name: 'El Salvador', lat: 13.7942, lon: -88.8965 },
  { code: 'NI', name: 'Nicaragua', lat: 12.8654, lon: -85.2072 },
  { code: 'CR', name: 'Costa Rica', lat: 9.7489, lon: -83.7534 },
  { code: 'PA', name: 'Panama', lat: 8.538, lon: -80.7821 },
];
...
const DEMONYMS: Record<string, string> = {
  ...
  'omani': 'OM', 'muscat': 'OM',
  'palestinian': 'PS', 'gaza': 'PS', 'west bank': 'PS', 'ramallah': 'PS',
  // Americas additions
  'haitian': 'HT', 'port-au-prince': 'HT',
  'guatemalan': 'GT',
  'honduran': 'HN', 'tegucigalpa': 'HN',
  'salvadoran': 'SV', 'san salvador': 'SV',
  'nicaraguan': 'NI', 'managua': 'NI',
  'panamanian': 'PA', 'panama city': 'PA',
};
